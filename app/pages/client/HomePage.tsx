...
import HomeStatBadge from "@components/HomeStatBadge";
...
export default function HomePage() {
  ...
  return (
    <Box>
      ...
      <HomeProducts featured={featured}></HomeProducts>

      {/* BANNER PROMOCIONAL */}
      <HomePromo
        openRegras={openRegras}
        setOpenRegras={setOpenRegras}
      ></HomePromo>
...
function HomeCategories({ categories }: IHomeCategoriesProps) {
  return (
    <Container sx={{ mt: 5 }}>
      <Stack
        direction="row"
...
function HomeProducts({ featured }: IHomeProductsProps) {
  return (
    <Container sx={{ mt: 5 }}>
      <Stack
        direction="row"
      ...
      <Grid container spacing={2}>
        {featured.map((product: ProductType) => (
          <Grid key={product.id} sx={{ xs: 12, sm: 6, md: 3 }}>
            <HomeProductCard product={product as ProductType} />
          </Grid>
        ))}
      </Grid>
    </Container>
...
function HomePromo({ openRegras, setOpenRegras }: IHomePromoProps) {
  return (
    <Container sx={{ mt: 6 }}>
      <Paper
        sx={{
          ...
          <Grid sx={{ xs: 12, md: 8 }}>
            ...
            <Grid>
              ...
              >
                ...
                <Button variant="outlined" onClick={() => setOpenRegras(true)}>
                  Regras
                </Button>
              </Stack>
            </Grid>
      ...
      <Grid container spacing={2}>
        <Grid sx={{ xs: 12, md: 4 }}>
          ...
          >
            ...
            <Typography color="text.secondary" sx={{ mt: 0.5 }}>
              Selecione poucos itens, mas certeiros. Nós destacamos o essencial.
            </Typography>
          </Paper>
        </Grid>
        <Grid sx={{ xs: 12, md: 4 }}>
        ...
        <Grid sx={{ xs: 12, md: 4 }}>
          ...
          >
            ...
            <Typography color="text.secondary" sx={{ mt: 0.5 }}>
              Frete local rápido, retirada em loja ou envio por transportadora.
            </Typography>
          </Paper>
        </Grid>
      </Grid>
